> # 📦 АРХИВ — ИСТОРИЧЕСКАЯ СПРАВКА (достоверна)
>
> **Перемещено в архив 2026-09-18.** Документ корректен и описывает прошлый рефакторинг;
> он остаётся полезным как история, но **не описывает текущее состояние**.
>
> **Актуальное состояние:** `docs/architecture.md`
> **Актуальные проблемы:** `docs/known-issues.md`
